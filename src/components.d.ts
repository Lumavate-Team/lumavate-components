...
declare global {
  ...
  namespace StencilComponents {
    interface LumavateCamera {
      'buttonLabel': string;
      'changeFilter': () => void;
      'getAuthToken': () => string;
      'getSessionToken': () => string;
      'handleError': (error: any) => void;
      'handleSuccess': (stream: any) => void;
      'headers': Headers;
      'method': string;
      'takePicture': () => void;
      'url': string;
  ...
  interface HTMLLumavateCameraElement extends StencilComponents.LumavateCamera, HTMLStencilElement {}
...
declare global {
  ...
  interface HTMLLumavateQrScannerElement extends StencilComponents.LumavateQrScanner, HTMLStencilElement {}
